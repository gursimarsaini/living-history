...
df2 = pd.read_csv('../generatedData/LabeledData.csv')
nlp = spacy.load('en_core_web_lg')

b = df2['Description'][0]
pairs2 = get_entity_pairs(b)
for i in range(1,5000):
    try:
        pairs2 = pairs2.append(get_entity_pairs(df2['Description'][i]), ignore_index = True)
    except:
        print('error')
    print(i)
pairs2.to_csv('../generatedData/relations.csv')
